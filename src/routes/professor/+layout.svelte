			...
			<div class="flex h-16 justify-between"> -->
				<Navbar  let:hidden let:toggle>
					...
					<Dropdown placement="bottom" triggeredBy="#avatar-menu" >
						...
						<!-- <DropdownDivider /> -->
						<DropdownItem>
							<!-- <NavLi href="/professor/logout">Logout</NavLi> -->
					...
					<NavUl>
						<NavLi href="/professor/dashboard" active={true}>Home</NavLi>
						<!-- <NavLi href="/dashboard">Dashboard</NavLi> -->
						<NavLi href="/professor/students">Students</NavLi>
						<!-- <NavLi href="/professor/professors">Professors</NavLi> -->
						<!-- <NavLi href="/professor/subjects">Subjects</NavLi> -->
						<NavLi href="/professor/exams">Exams</NavLi>
						<NavLi href="/professor/questions">Questions</NavLi>
					</NavUl>
				</Navbar>
			<!-- </div>
		</div>
