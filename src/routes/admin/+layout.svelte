<script lang="ts">
	...
	let user:any = {}, userName:any, userEmail: any;
...
<div class="min-h-full relative">
			...
			<div class="flex h-16 justify-between"> -->
				<Navbar  let:hidden let:toggle>
					...
					<Dropdown placement="bottom" triggeredBy="#avatar-menu" >
						...
						<!-- <DropdownDivider /> -->
						<DropdownItem>
							<!-- <NavLi href="/admin/logout">Logout</NavLi> -->
							<NavLi on:click={logout}>Logout</NavLi>
						</DropdownItem>
						
					</Dropdown>
					<NavUl>
						<NavLi href="/admin/dashboard" active={true}>Home</NavLi>
						<!-- <NavLi href="/dashboard">Dashboard</NavLi> -->
						<NavLi href="/admin/students">Students</NavLi>
						<NavLi href="/admin/professors">Professors</NavLi>
						<NavLi href="/admin/subjects">Subjects</NavLi>
						<NavLi href="/admin/exams">Exams</NavLi>
						<!-- <NavLi href="/admin/questions">Questions</NavLi> -->
					</NavUl>
				</Navbar>
			<!-- </div>
		</div>
	...
	<Footer class="absolute bottom-0 start-0 w-full text-center">
		<FooterCopyright href="/" by="FVNZ2P" year={2023} class="text-center" />
	</Footer>
</div>
